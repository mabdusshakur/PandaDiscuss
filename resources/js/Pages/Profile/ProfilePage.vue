...
<template>
    <div class="flex justify-center items-center h-screen bg-gradient bg-gradient-to-t from-white to-pink-100">
        <div class="p-2 shadow-lg rounded-lg">
            ...
            <button type="button"
                class=" mt-2 rounded-lg border border-pink-500 bg-pink-500 px-3 py-1.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-pink-600 hover:bg-pink-600 focus:ring focus:ring-pink-200 disabled:cursor-not-allowed disabled:border-pink-300 disabled:bg-pink-300">Save</button>
        </div>
    </div>
</template>
<style scoped></style>